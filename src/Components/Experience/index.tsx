      ...
      <Row>
        <Col className="timeline mt-3">
          <section aria-labelledby="dutchbros">
            ...
            <div>
              <h3>
                <i className="bi bi-geo-alt-fill"></i> Fresno, CA/Grants Pass,
                OR
              </h3>
              <h3>
              ...
              <p>
                Worked with development team to harden internal admin Portal
              </p>
              <ul>
                <li>
                ...
                <li>
                  Meet defined milestones in developing enterprise Python/Vue
                  apps
                </li>
          ...
          <section aria-labelledby="experian">
            ...
            <div>
              ...
              <ul>
                <li>
                  <strong>Web Accessibility Expert</strong> for Experian's
                  client, <strong>Wells Fargo</strong>
                </li>
                <li>
          ...
          <section aria-labelledby="edesign">
            ...
            <div>
              ...
              <p>
                Tight knit print and web family; building projects for
            ...
            <div>
              ...
              <ul>
                <li>
                  ...
                  client communication: nonprofits, higher education,
